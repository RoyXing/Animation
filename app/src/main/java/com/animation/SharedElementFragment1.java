...
public class SharedElementFragment1 extends Fragment {
    ...
    private void addNextFragment(Sample sample, ImageView squareBlue, boolean overlap) {
        ...
        getFragmentManager().beginTransaction().replace(R.id.sample2_content, sharedElementFragment2)
                .addToBackStack(null)
                .addSharedElement(squareBlue, getString(R.string.square_blue_name)).commit();
